...
def process_single_symbol(data_pack):
    sym, arr_price, arr_order_flow, arr_price_change, arr_market_volume, arr_volatility = data_pack
    MAX_TICKS = 5500
    ...
    for file in parquet_files:
        ...
        try:
            ...
            for sym, group_df in symbol_groups.items():
                ...
                pack_list.append((sym, arr_price, arr_order_flow, arr_price_change, arr_market_volume, arr_volatility))
            ...
            # Unpack results
            all_prices, all_flows, all_price_changes, all_residuals, all_epiplexity = zip(*results)
