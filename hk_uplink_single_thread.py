...
def upload_file(file, target, gcs_bucket, tmp_dir):
...
if __name__ == "__main__":
    ...
    print(f"🎯 Found {len(files)} shards. Starting rock-solid single-threaded transport...", flush=True)
    
    for i, f in enumerate(files):
        result = upload_file(f, target, gcs_bucket, tmp_dir)
